function initMap() 
{
		        ...
		        google.maps.event.addListener(map, 'click', function(event) {
		        	//alert(event.latLng.lat());
		          	...
		          	CambiarContenido(Math.abs(event.latLng.lat()).toFixed(2));
				...
				/*map.addListener('dblclick', function() {
					...
					//alert(Math.abs(map.getCenter().lat()).toFixed(2));
					CambiarContenido(Math.abs(map.getCenter().lat()).toFixed(2));
...
function CambiarContenido(valor){
	if(cambio){
		document.getElementById("sourcevid").innerHTML= "<video  autoplay='true' loop='true' width='600' height='100%'><source src='videos/barcelona_vs_santos.mp4' type='video/mp4'/></video>";	
		cambio= false;
	}
	else{
		document.getElementById("sourcevid").innerHTML= "<video  autoplay='true' loop='true' width='600' height='100%'><source src='videos/pato.mp4' type='video/mp4'/></video>";	
		cambio= true;
	}

	basic_pie(document.getElementById('content_grafico'),valor);
}	
